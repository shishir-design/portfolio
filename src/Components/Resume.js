  ...
  render() {
    ...
    return (
      ...
      <div className="row skill">
         ...
         <div className="nine columns main-col">
            <p>it is easy to update or deploy in a cloud service provider. You can use the same frameworks as 
            Oxygen desktop applications to make sure all your users have the same editing experience..
            </p>
				<div className="bars">
				   <ul className="skills">
					  {skills}
